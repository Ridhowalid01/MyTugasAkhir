...
class DetailHijaiyahAlternatifActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDetailBinding
    private lateinit var hijaiyahData: HijaiyahAlternatif
...
//            deleteAudioFile()
    ...
    private fun getHijaiyahDataFromIntent(): HijaiyahAlternatif {
        return if (Build.VERSION.SDK_INT >= 33) {
            intent.getParcelableExtra("hijaiyahData", HijaiyahAlternatif::class.java)!!
        } else {
        ...
        call.enqueue(object : Callback<String> {
            override fun onResponse(call: Call<String>, response: Response<String>) {
                ...
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@DetailHijaiyahAlternatifActivity, "Score: $score", Toast.LENGTH_LONG).show()
                    Log.d("Index", "nomor index2: $index")
                    Log.d("Score", "Score : $score")
                } else {
                    Toast.makeText(this@DetailHijaiyahAlternatifActivity, "Failed to get score", Toast.LENGTH_LONG).show()
                }
            }
            ...
            override fun onFailure(call: Call<String>, t: Throwable) {
                ...
                Toast.makeText(this@DetailHijaiyahAlternatifActivity, "Error: ${t.message}", Toast.LENGTH_LONG).show()
            }
        })
    }
// ======================================= START OF RECORDING ====================================
